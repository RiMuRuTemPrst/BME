 ...
 * @brief Measure temperature and humidity by BME280 and display on screen.
 * @note BME280 uses protocol I2C.
 * @version 0.1
 * @date 2023-11-14
 * 
...
#define SDA_PIN GPIO_NUM_21                     /** SDA pin: 21 */
#define SCL_PIN GPIO_NUM_22                     /** SCL pin: 22 */
#define TAG_BME280 "BME280"                     /** This tag used for ESP_LOGI */

#define I2C_MASTER_ACK 0                        /** ACK help slave confirm that master receive data successfully  */
#define I2C_MASTER_NACK 1                       /** When NACK (Not acknowledge) mode, change Pin to High signal level to stop receiving data*/
